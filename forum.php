...
?>
  ...
  <div class= "comment">Add a comment: <input size="140" value="<?php echo isset($_SESSION['form_input']['comment']) ? $_SESSION    ['form_input']['comment'] : ''; ?>" type="text" id="comment" name="comment"></div> 
