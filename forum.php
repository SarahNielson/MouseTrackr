...
if(!(isset($_SESSION["logged_in"]) && $_SESSION["logged_in"] == true)){
    echo '<span style="color:#383838;background-color:white;padding:5; margin:10;"><strong>You are not signed in. You can <a href="about.php">sign in</a> if you want to leave a comment.</strong></span>';
